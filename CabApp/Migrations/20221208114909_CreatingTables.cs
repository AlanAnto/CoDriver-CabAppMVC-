        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    CabName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CabDrivers_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabRideTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CabType = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_CabDrivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CabDrivers_LicenseNumber",
                table: "CabDrivers",
